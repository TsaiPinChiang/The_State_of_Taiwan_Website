...
export function TeamCard({ img, name, position, socials, intro, facility }) {
  ...
  return (
    ...
    <CardHeader floated={false} color="transparent" shadow={false} className="mx-0 flex place-content-center">
      <img src={img} className="h-60 w-60 rounded-full" />
    </CardHeader>
    ...
    <Fragment>
      <div className="mt-0">
        <Button onClick={handleOpen} color="gray" className="rounded-full">
